...
const oidcConfig = {
  authority: "http://localhost:9090/realms/restaurant",
...
const authConfig = {
   clientId: 'event-ticket-platform-app',
    authorizationEndpoint: 'http://localhost:9090/realms/restaurant/protocol/openid-connect/auth',
    tokenEndpoint: 'http://localhost:9090/realms/restaurant/protocol/openid-connect/token',
