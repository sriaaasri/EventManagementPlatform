  ...
  if (error) {
    /*return (
      <div className="bg-black min-h-screen text-white">
        <NavBar />
        <Alert variant="destructive" className="bg-gray-900 border-green-700">
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      ...
      <div className="max-w-lg mx-auto">
        { tickets!= undefined && tickets?.content.map((ticketItem) => (
          <Link to={`/dashboard/tickets/${ticketItem?.id}`}>
            <Card key={ticketItem?.id} className="bg-gray-900 text-white mb-3">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="font-medium">Ticket ID:  <span className="text-gray-400 font-medium text-lg">
                      {ticketItem?.id}
                    </span></h4>
