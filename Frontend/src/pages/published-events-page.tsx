...
const PublishedEventsPage: React.FC = () => {
  ...
  // const { isAuthenticated, isLoading, signinRedirect, signoutRedirect } = useContext(AuthContext);
  ...
  if (error) {
   /* return (
    ...
    console.log("Error in Event Page "+ error);
  }
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-2 gap-8 max-w-5xl mx-auto mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 text-lg mt-4 text-gray-100">
