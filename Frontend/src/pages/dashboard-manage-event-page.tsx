...
const isTempId = (id: string | undefined) => id && typeof id === "string" && id+"".startsWith("temp_");
              ...
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                ...
                <CardContent className="space-y-2">
                  {eventData.ticketTypes.map((ticketType , index) => {
                    return (
                      <div className="bg-gray-700 w-full p-4 rounded-lg border-gray-600" key={index}>
            ...
            >
              ...
              <SelectContent className="bg-gray-900 border-gray-700 text-white">
                ...
                <SelectItem value={EventStatusEnum.PUBLISHED}>
                 ...
                 <SelectItem value={EventStatusEnum.CANCELLED}>Cancelled</SelectItem>
                  <SelectItem value={EventStatusEnum.COMPLETED}>Completed</SelectItem>
              </SelectContent>
            </Select>
            <p className="text-gray-400 text-xs">
